jQuery(function(){
	...
	*/
	...
	jQuery('#cfg-contactform-30 .cfg-uploadfilename').val(''); // FF may keep the file name in the cfg-uploadfilename input after submitting and refreshing the page
	
	jQuery('#cfg-contactform-30 .cfg-captcha-refresh').click(function(){
		
		jQuery('#cfg-contactform-30 .cfg-captcha-img').attr('src','cfg-contactform-30/inc/captcha.php?r='+Math.random());
	});
	
	jQuery('#cfg-contactform-30 .cfg-submit').click(function(){
		...
		jQuery.post('cfg-contactform-30/inc/form-validation.php',
				{ 
	...
	jQuery('body').on('click', '#cfg-contactform-30 .cfg-deleteupload', function()
	{
